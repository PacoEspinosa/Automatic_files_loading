...
stratified_sample_report(partition, ['behavior','Categoria_1'],209874

df = stratified_sample(partition, ['behavior','Categoria_1'],209874)

df.to_csv(r'campaña_tnp_envio.csv')

sql_text = 'Select * from Campania_TDC_Clasica.Campania_TNP;'
universe = pd.read_sql(sql_text, con)
universe.to_csv(r'campaña_tnp_total.csv')
