...
#funciones
#Constantes
filepattern = 'portafolio_capta'
fileext = ".dat"
staging_table1 = 'tmp_portafolio_capta'
table = 'Cuentas_tc.Portafolio_capta'
pasos_proceso = 3
proceso = 'Carga Portafolio captacion'
...
for filename1 in files:
    ...
    #Staging
            ...
            staging_step_3a = "insert ignore into " + table + " select * from Staging." + staging_table1
            staging_step_3a += ";"
            cursor.execute(staging_step_3a)
            cf.logging_proceso(cursor,proceso + ': ' + filename,pasos_proceso,paso,'Inserta_tabla_portafolio')
