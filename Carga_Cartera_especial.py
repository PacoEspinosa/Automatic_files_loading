...
if filename1 in files and filename2 in files:
    ...
    try:
        ...
        if cf.Validacion_archivo(cursor, filename1) or cf.Validacion_archivo(cursor, filename2):
            ...
            paso = 1
            #mes_ant_procesado = (datetime.datetime.today() - datetime.timedelta(56)).strftime("%Y%m")
            mes_ant_procesado = '202012'
            staging_step_1a = "RENAME TABLE Cuentas_tc.Cartera TO Cuentas_tc.Cartera_" + mes__ant_procesado
